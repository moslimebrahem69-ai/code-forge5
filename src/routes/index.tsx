...
// ============ Data ============
const ROADMAPS = [
  { en: "Frontend", ar: "الواجهات الأمامية", icon: "fa-code", color: "from-cyan-400 to-blue-500", pct: 85 },
  { en: "Backend", ar: "الواجهات الخلفية", icon: "fa-server", color: "from-emerald-400 to-teal-500", pct: 78 },
  { en: "Full Stack", ar: "Full Stack", icon: "fa-layer-group", color: "from-violet-400 to-fuchsia-500", pct: 92 },
  { en: "Python", ar: "Python", icon: "fa-python", color: "from-yellow-300 to-blue-500", pct: 95, brand: "fab" },
  { en: "Java", ar: "Java", icon: "fa-java", color: "from-orange-400 to-red-500", pct: 80, brand: "fab" },
  { en: "C++", ar: "C++", icon: "fa-code", color: "from-blue-400 to-indigo-600", pct: 70 },
  { en: "C#", ar: "C#", icon: "fa-hashtag", color: "from-violet-500 to-purple-700", pct: 72 },
  { en: "JavaScript", ar: "JavaScript", icon: "fa-js", color: "from-yellow-300 to-amber-500", pct: 96, brand: "fab" },
  { en: "React", ar: "React", icon: "fa-react", color: "from-cyan-300 to-blue-500", pct: 90, brand: "fab" },
  { en: "Node.js", ar: "Node.js", icon: "fa-node-js", color: "from-emerald-400 to-green-600", pct: 88, brand: "fab" },
  { en: "Flutter", ar: "Flutter", icon: "fa-mobile-screen", color: "from-sky-400 to-blue-600", pct: 76 },
  { en: "AI", ar: "الذكاء الاصطناعي", icon: "fa-brain", color: "from-fuchsia-400 to-violet-600", pct: 91 },
  { en: "Machine Learning", ar: "تعلم الآلة", icon: "fa-robot", color: "from-pink-400 to-rose-500", pct: 84 },
  { en: "Cyber Security", ar: "الأمن السيبراني", icon: "fa-shield-halved", color: "from-red-400 to-orange-500", pct: 82 },
  { en: "Data Science", ar: "علم البيانات", icon: "fa-chart-line", color: "from-teal-400 to-cyan-500", pct: 87 },
  { en: "Mechatronics", ar: "ميكاترونكس", icon: "fa-gears", color: "from-amber-400 to-orange-600", pct: 65 },
  { en: "Embedded Systems", ar: "الأنظمة المدمجة", icon: "fa-microchip", color: "from-lime-400 to-green-600", pct: 68 },
  { en: "Arduino", ar: "Arduino", icon: "fa-bolt", color: "from-cyan-400 to-teal-500", pct: 60 },
  { en: "ESP32", ar: "ESP32", icon: "fa-wifi", color: "from-blue-400 to-indigo-500", pct: 62 },
  { en: "IoT", ar: "إنترنت الأشياء", icon: "fa-network-wired", color: "from-emerald-400 to-cyan-500", pct: 74 },
];
