...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "أكاديمية Software Engineer: تعلّم البرمجة من الصفر للاحتراف عبر مسارات تعليمية، كورسات مجانية، مشاريع عملية، ونصائح لسوق العمل." },
      { property: "og:title", content: "Software Engineer — تعلم البرمجة واحترف هندسة البرمجيات" },
      { property: "og:description", content: "أكاديمية Software Engineer: تعلّم البرمجة من الصفر للاحتراف عبر مسارات تعليمية، كورسات مجانية، مشاريع عملية، ونصائح لسوق العمل." },
