...
export default defineMcp({
  ...
  version: "0.1.0",
  instructions:
    "Tools for exploring the Software Engineer academy: browse courses (with YouTube URLs), learning roadmaps, and covered programming languages. All content is public and available in Arabic and English.",
